                ...
                <div className="col-xl-12">
                    <div className="mb-4">
                        <ul className="d-flex align-items-center flex-wrap">
                            ...
                            <li><Link to={"/blog-cate"} className="btn btn-primary mx-1 btn-sm">Blog Category</Link></li>
                            <li><Link to={"/blog-cate"} className="btn btn-primary me-1 mt-1 mt-sm-0 btn-sm">Add Blog Category</Link></li>
                            <li>
                                <Link to={"#"} className="btn btn-primary open mt-1 mt-md-0 btn-sm"
                            ...
                            {!state.section0 &&
                                <div className="filter cm-content-box box-primary">
                                    <div className="content-title"  onClick={() => dispatch({type:'collpase0'})}>
                                        <div className="cpa">Expert</div>
                                        <div className="tools">
                                            <Link to={"#"} 
                                                className={`handle ${state.collpase0 ? '' : 'expand' }`}                                               
                                            >
                                    ...
                                    <Collapse in={!state.collpase0}>
                                        <div className="cm-content-body publish-content form excerpt">
                                            <div className="card-body">
                                                ...
                                                <div className="form-text">Expert are optional hand-crafted summaries of your content that can be used in your theme. </div>
                                                </div>
                                            </div>                                            
                                        </div>
                                    </Collapse>
                                    ...
                                    <div className="content-title" onClick={() => dispatch({type:'collpase1'})}>
                                        ...
                                        <div className="tools">
                                            <Link to={"#"}                                                 
                                                ...
                                                className={`handle ${state.collpase1 ? 'collapse' : 'expand' }`}
                                            >
                                                <i className="fas fa-angle-up" />
                                            </Link>
                                        </div>
                            ...
                            {!state.section2 &&
                                <div className="filter cm-content-box box-primary">
                                    <div className={`content-title`} onClick={() => dispatch({type:'collpase2'})}>
                                        ...
                                        <div className="tools">
                                            <Link to={"#"} 
                                                className={`handle ${state.collpase2 ? 'collapse' : 'expand' }`}                                                
                            ...
                            {!state.section3 &&
                                <div className="filter cm-content-box box-primary">
                                    <div className="content-title" onClick={() => dispatch({type:'collpase7'})}>
                                        ...
                                        <div className="tools">
                                            <Link to={"#"} 
                                                className={`handle ${state.collpase7 ? 'collapse' : 'expand' }`}                                                
                            ...
                            {!state.section4 &&
                                <div className="filter cm-content-box box-primary">
                                    <div className="content-title" onClick={() => dispatch({type:'collpase8'})}>
                                        ...
                                        <div className="tools">
                                            <Link to={"#"} 
                                                className={`handle ${state.collpase8 ? 'collapse' : 'expand' }`}                                                
                            ...
                            {!state.section5 &&
                                <div className="filter cm-content-box box-primary">
                                    <div className="content-title" onClick={() => dispatch({type:'collpase9'})}>
                                        ...
                                        <div className="tools">
                                            <Link to={"#"} 
                                                className={`handle ${state.collpase9 ? 'collapse' : 'expand' }`}                                                
							...
							<div className="right-sidebar-sticky">
                                {!state.section6 &&
                                    <div className="filter cm-content-box box-primary">
                                        <div className={`content-title`} onClick={() => dispatch({type:'collpase3'})}>
                                            ...
                                            <div className="tools">
                                                <Link to={"#"} 
                                                    className={`handle ${state.collpase3 ? 'collapse' : 'expand' }`}                                              
                                ...
                                {!state.section7 &&
                                    ...
                                    <div className="content-title"  onClick={() => dispatch({type:'collpase4'})}>
                                        ...
                                        <div className="tools">
                                            <Link to={"#"}
                                                className={`handle ${state.collpase4 ? 'collapse' : 'expand' }`}
                                ...
                                {!state.section8 &&
                                    <div className="filter cm-content-box box-primary">
                                        <div className="content-title"  onClick={() => dispatch({type:'collpase5'})}>
                                            ...
                                            <div className="tools">
                                                <Link to={"#"}
                                                    className={`handle ${state.collpase5 ? 'collapse' : 'expand' }`}
                                ...
                                {!state.section9 &&
                                    <div className="filter cm-content-box box-primary">
                                        <div className="content-title" onClick={() => dispatch({type:'collpase6'})}>
                                            ...
                                            <div className="tools">
                                                <Link to={"#"}
                                                    className={`handle ${state.collpase6 ? 'collapse' : 'expand' }`}
                                                    ...
                                                    <div className="avatar-upload d-flex align-items-center">
                                                        <div className=" position-relative ">
                                                            ...
                                                            <div className="change-btn d-flex align-items-center flex-wrap">
                                                                <input type="file" className='d-none' onChange={fileHandler} id="imageUpload" /> 					                                                           
