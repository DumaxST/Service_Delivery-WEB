    ...
    return(
        <>
            ...
            <div className="row mb-5 align-items-center">
                        ...
                        <div className="modal-body">
                            ...
                            <div className="add-contact-box">
                                <div className="add-contact-content">
                                    ...
                                    <div className="form-group">
                                        <label className="text-black font-w500">Occupation <span className='required'>*</span></label>
                                        <div className="contact-occupation">
                                            <input type="text"  autoComplete="off"
                ...
                <Modal  show={editModal} onHide={setEditModal} centered>
                    <form >
                        <div className="modal-header">
                            <h4 className="modal-title fs-20">Add Contact</h4>
                        ...
                        <div  className="card project-boxed">
                            ...
                            <div className="card-header align-items-start">
                                <div>
                                    ...
                                    <div className="text-dark fs-14 text-nowrap"><i className="fa fa-calendar me-3" />Created on Sep 8th, 2023</div>
                                </div>
