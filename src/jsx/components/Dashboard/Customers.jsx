                            ...
                            <div className="">
                                <form >
                                    <div className="modal-header">
                                        ...
                                        <button type="button" className="btn-close" onClick={()=> setAddItem(false)}>
                                        </button>
                                    </div>
                                        ...
                                        <div className="add-contact-box">
                                            <div className="add-contact-content">
                                                <div className="form-group">
                                                    <label className="text-black font-w500">Cust_Id <span className='required'>*</span></label>
                                                ...
                                                <div className="form-group">
                                                    <label className="text-black font-w500">Ticket Date <span className='required'>*</span></label>
                                                    <div className="contact-name">
                                                ...
                                                <div className="form-group">
                                                    <label className="text-black font-w500">Customer Name <span className='required'>*</span></label>
                                                    <div className="contact-name">
                                                ...
                                                <div className="form-group">
                                                    <label className="text-black font-w500">Ticket Summary <span className='required'>*</span></label>
                                                    <div className="contact-name">
                                                ...
                                                <div className="form-group">
                                                    <label className="text-black font-w500">Price <span className='required'>*</span></label>
                                                    <div className="contact-name">
