								...
								<div className="card-body pt-2">
									<div className="index-chart-point">
										...
										<ul className="index-chart-point-list">
											<li><i className="fa fa-stop text-danger"/>Tickets A</li>
											<li><i className="fa fa-stop text-success"/> Tickets B</li>
											<li><i className="fa fa-stop text-warning"/> Tickets C</li>
											<li><i className="fa fa-stop text-info"/> Tickets D</li>
										</ul>
									</div>
								</div>
							</div>
